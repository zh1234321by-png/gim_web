...
export default function ProductsPage() {
  return <PageShell><main>
    <section className="page-hero product-page-hero"><p className="eyebrow"><span /> DATA PRODUCTS / XUST</p><h1>电离层产品服务</h1><p>检索、下载并分析 XUST 全球电离层图与差分码偏差产品。实时产品入口已预留。</p></section>
    ...
    <section className="page-section product-cards-section">
      ...
      <div className="product-cards">
        <article><span>01 / GIM</span><h3>全球电离层图</h3><p>IONEX 1.0 格式，1 小时时间分辨率，采用 IGS 长命名与传统短命名并行发布。</p><dl><div><dt>空间分辨率</dt><dd>2.5° × 5°</dd></div><div><dt>参考高度</dt><dd>450 km</dd></div><div><dt>时效</dt><dd>事后 / 实时规划</dd></div></dl></article>
        ...
        <article className="coming-card"><span>03 / RT</span><h3>实时电离层产品</h3><p>实时电离层建模与短临预报服务正在接入。正式上线后可在同一检索器中按时间与产品类型访问。</p><div className="coming-status"><i /> PIPELINE RESERVED</div></article>
      </div>
    </section>
    <section className="page-section format-section">
      ...
      <div className="code-list"><code>XAN0OPSRAP_20240010000_01D_01H_GIM.INX.gz</code><code>XAN0MGXRAP_20240010000_01D_01D_DCB.BSX.gz</code><code>xan24001.ION.gz</code></div>
    </section>
