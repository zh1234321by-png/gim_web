...
export default function TeamPage() {
  return <PageShell><main>
    ...
    <section className="page-section join-section"><div><p className="section-kicker">JOIN US · 招生合作</p><h2>把好奇心带到真实数据中</h2></div><p>欢迎测绘、遥感、地理信息、计算机、数学等相关背景的同学联系。来信可简要介绍研究兴趣、专业基础与希望参与的方向。</p><a className="button primary" href={`mailto:${content.site.email}`}>联系课题组 →</a></section>
  </main></PageShell>;
}
